          ...
          <div class="px-4">
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img
                      v-lazy="'img/brand/logo_icon_about.png'"
              ...
              >
                <div class="card-profile-actions py-4 mt-lg-0">
                  <a href="https://www.facebook.com/Baccho.It"
                    ...
                    ></a
                  >
                  <a href="https://www.instagram.com/baccho_it/"
            ...
            <div class="text-center" style="margin-top: 4rem;">
              ...
              <div class="h6 font-weight-300">
                <i class="ni location_pin mr-2"></i>Salerno, Italia
              </div>
              <div class="h5 mt-4">
                <i class="ni business_briefcase-24 mr-2"></i>Dalla terra a casa
                tua.
              </div>
            </div>
            <div class="mt-5 py-5 border-top text-center">
              <div class="row justify-content-center">
                <div class="col-lg-9">
                  <p>
                    Baccho è una piattaforma di consegna di cibo genuino.
                    Attraverso il nostro servizio è possibile ordinare e
                    ricevere in 24 ore direttamente a casa il miglior cibo di
                    qualità proveniente dalle terre del cilento e della costiera
                    amalfitana.
                  </p>
                  <a href="/">Ordina ora</a>
                </div>
